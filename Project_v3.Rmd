...
In our summary statistics we can see the obvious minumum and maximum as well as the mean, median and quartiles. This will help us further understand the behaviour of the graph. According to the which, the most likely times a person calls are between 8am and 5pm. There is a peak between the 11th and 12th hour and a dip between 20 and 5. Because this is 24 hour scale we can say the dip is between 20 and 5.
