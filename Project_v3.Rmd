...
# The names of our variables were summarized by r studio leading to names such as "Disp_d....m"
# In order to be able to clearly use the data, we decided to modify them.
...
# Additional latitude and longitude columns for posterior use
fire <- fire %>% 
...
ggplot(data = alarm, 
       mapping = aes(x= Hour)) +
  geom_histogram(color = 'purple', fill = 'pink', binwidth = 1) +
